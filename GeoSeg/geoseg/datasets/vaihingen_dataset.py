...
class VaihingenDataset(Dataset):
    ...
    def get_img_ids(self, data_root, img_dir, mask_dir):
        ...
        img_filename_list = [f for f in os.listdir(img_path) if f.endswith(self.img_suffix) and f != '.ipynb_checkpoints']
        mask_filename_list = [f for f in os.listdir(mask_path) if f.endswith(self.mask_suffix) and f != '.ipynb_checkpoints']
